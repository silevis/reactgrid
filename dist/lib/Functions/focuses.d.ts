...
export declare const moveFocusPage: (rowCalculator: RowCalcFn) => (state: State) => State<import("../Model/CellMatrix").CellMatrix<import("../Model/CellMatrix").StickyRanges, import("../Model/CellMatrix").CellMatrixProps>, import("../Model/Behavior").Behavior>;
export declare const moveFocusPageUp: (state: State) => State<import("../Model/CellMatrix").CellMatrix<import("../Model/CellMatrix").StickyRanges, import("../Model/CellMatrix").CellMatrixProps>, import("../Model/Behavior").Behavior>;
export declare const moveFocusPageDown: (state: State) => State<import("../Model/CellMatrix").CellMatrix<import("../Model/CellMatrix").StickyRanges, import("../Model/CellMatrix").CellMatrixProps>, import("../Model/Behavior").Behavior>;
...
export declare function withMoveFocusPage(fc: FocusCellFn): (rowCalculator: RowCalcFn) => (state: State) => State<import("../Model/CellMatrix").CellMatrix<import("../Model/CellMatrix").StickyRanges, import("../Model/CellMatrix").CellMatrixProps>, import("../Model/Behavior").Behavior>;
