      ...
      <div className="relative grid grid-cols-main  bg-green-primary pt-12 pb-12 md:pt-32 md:pb-24">
        ...
        >
          <p className="text-center text-xs md:text-sm px-4 py-4">
            ...
            options for organizing information, you can create intuitive and
            clear tables that facilitate analysis and presentation. You can
            customize the layout, formatting, and interactivity to achieve the
