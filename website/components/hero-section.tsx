...
export const HeroSection = () => {
  ...
  return (
    <div className="pb-4 box-border font-dm-sans bg-green-primary text-md 2xl:text-xl text-white-primary">
      <div className="hero-section grid grid-cols-main grid-rows-header-xs sm:grid-rows-header max-w-screen-3xl mx-auto">
