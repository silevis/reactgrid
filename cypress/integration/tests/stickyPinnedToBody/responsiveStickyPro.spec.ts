...
import { enableResponsiveStickyPinnedToBodyPro as config } from "../../../../src/test/testEnvConfig";
import { visitResponsiveStickyPinnedToBodyPro } from "../../common/visit";
...
context("Responsive sticky", () => {
  beforeEach(() => {
    cy.viewport(500, 600);
    visitResponsiveStickyPinnedToBodyPro();
  });
