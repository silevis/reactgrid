...
| `groupId?`     | [`Id`](/docs/3.1/7-api/1-types/4-id/)                        | [`Id`](/docs/3.1/7-api/1-types/4-id/) of group to which this cell belongs to |
| `style?`       | [`CellStyle`](/docs/3.1/7-api/0-interfaces/7-cell-style/)    | Allowed style properties contained in [`CellStyle`](/docs/3.1/7-api/0-interfaces/7-cell-style/) interface |
