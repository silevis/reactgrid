...
`CellTypes` utility type extracts all possible cell types based on [`Cell`](/docs/3.1/7-api/0-interfaces/4-cell/) interface.
...
`TCell` is type that extends common [`Cell`](/docs/3.1/7-api/0-interfaces/4-cell/) type. 
It can be one of [default cell types](/docs/3.1/7-api/1-types/6-default-cells/) or one of yours. 
Read more about creating [custom cell templates](/docs/3.1/5-create-your-own-cell-template/).

#### Properties

| Property name     | Type                                                                      | Property description      | 
| ------------      | -------------                                                             | --------------------      |
| `rowId`           | [`Id`](/docs/3.1/7-api/1-types/4-id/)                                     | Row [`Id`](/docs/3.1/7-api/1-types/4-id/) where the change ocurred | 
| `columnId`        | [`Id`](/docs/3.1/7-api/1-types/4-id/)                                     | Column [`Id`](/docs/3.1/7-api/1-types/4-id/) where the change ocurred | 
| `type`            | `CellTypes<TCell>`                                                        | Extracted cell type of `TCell` e.g. `text`, `chevron` | 
| `previousCell`    | `TCell extends Cell = `[`Cell`](/docs/3.1/7-api/0-interfaces/4-cell/)     | Previous content of the cell | 
| `newCell`         | `TCell extends Cell = `[`Cell`](/docs/3.1/7-api/0-interfaces/4-cell/)     | New content of the cell | 
