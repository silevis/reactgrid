...
export class DropdownNumberCellTemplate
  implements CellTemplate<DropdownNumberCell>
{
  ...
  getCompatibleCell(
    uncertainCell: Uncertain<DropdownNumberCell>
  ): Compatible<DropdownNumberCell> {
  ...
  handleKeyDown(
    ...
    shift: boolean,
    alt: boolean
  ): { cell: Compatible<DropdownNumberCell>; enableEditMode: boolean } {
    return { cell, enableEditMode: false };
  }

  update(
    cell: Compatible<DropdownNumberCell>,
    cellToMerge: UncertainCompatible<DropdownNumberCell>
  ): Compatible<DropdownNumberCell> {
    ...
    return this.getCompatibleCell({
      ...cell,
      value: parsed > 0 || parsed < 0 ? parsed : 0,
    });
  }
