...
This guide is based on [handling data changes](/docs/3.1/2-implementing-core-features/1-handling-changes/).

1. Update imports by adding [`Id`](/docs/3.1/7-api/1-types/4-id/), [`SelectionMode`](/docs/3.1/7-api/1-types/7-selection-mode/) 
and [`MenuOption`](/docs/3.1/7-api/0-interfaces/8-menuoption/) interfaces.
