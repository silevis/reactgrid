...
| -----------       | ------                                    | -------------------- |
| `rowId`           | [`Id`](/docs/3.1/7-api/1-types/4-id/)     | Row [`Id`](/docs/3.1/7-api/1-types/4-id/) of the cell to highlight  |
| `columnId`        | [`Id`](/docs/3.1/7-api/1-types/4-id/)     | Column [`Id`](/docs/3.1/7-api/1-types/4-id/) of the cell to highlight  |
