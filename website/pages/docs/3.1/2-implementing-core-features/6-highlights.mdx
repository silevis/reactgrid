...
1. Import the [`Highlight`](/docs/3.1/7-api/0-interfaces/9-highlight/) interface

```ts
import { ReactGrid, Highlight } from "@silevis/reactgrid";
```

2. Define an array of [`Highlight`](/docs/3.1/7-api/0-interfaces/9-highlight/) objects
...
import { ReactGrid, Column, Row, Highlight } from "@silevis/reactgrid-3.1";
import LiveCode from "@/nextra/components/LiveCode.tsx"
import "@silevis/reactgrid-3.1/styles.css";

<LiveCode 
  scope={{ReactGrid, Column, Row, Highlight}}
