...
export class CssClassCellTemplate implements CellTemplate<CssClassCell> {
  getCompatibleCell(
    uncertainCell: Uncertain<CssClassCell>
  ): Compatible<CssClassCell> {
  ...
  handleKeyDown(
    ...
    shift: boolean,
    alt: boolean
  ): { cell: Compatible<CssClassCell>; enableEditMode: boolean } {
  ...
  render(
    ...
    onCellChanged: (cell: Compatible<CssClassCell>, commit: boolean) => void
  ): React.ReactNode {
