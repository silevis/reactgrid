...
export var GridRenderer = function (_a) {
    ...
    return (React.createElement(ErrorBoundary, null,
        React.createElement("div", { className: 'reactgrid', style: {
                position: 'relative',
