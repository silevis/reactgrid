...
| `onFillHandle`               | `(selectedArea: NumericalRange, fillRange: NumericalRange, cellsLookup: CellsLookup) => void` | Callback for fill handle action.                 |
| `onCut`                      | `(event: React.ClipboardEvent<HTMLDivElement>, cellsRange: NumericalRange, cellsLookup: CellsLookup) => void` | Callback for cut action.                         |
| `onCopy`                     | `(event: React.ClipboardEvent<HTMLDivElement>, cellsRange: NumericalRange, cellsLookup: CellsLookup) => void` | Callback for copy action.                        |
| `onPaste`                    | `(event: React.ClipboardEvent<HTMLDivElement>, cellsRange: NumericalRange, cellsLookup: CellsLookup) => void` | Callback for paste action.                       |
