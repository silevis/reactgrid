...
`cells` field allows you to declare an array of objects that extends [`Cell`](/docs/3.1/7-api/0-interfaces/4-cell/)`[]` base interface.
...
| ------------      | -------------                                                         | -------------         |
| `rowId`           | [`Id`](/docs/3.1/7-api/1-types/4-id/)                                 | Unique [`Id`](/docs/3.1/7-api/1-types/4-id/) in all rows array | 
| `cells`           | [`Cell`](/docs/3.1/7-api/0-interfaces/4-cell/)`[]  TCell extends` [`Cell`](/docs/3.1/7-api/0-interfaces/4-cell/)`[]`    | Array of [`Cell`](/docs/3.1/7-api/0-interfaces/4-cell/) objects. | 
