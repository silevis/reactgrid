...
Key of `CellTemplates` interface have to be equal to coresponding cell `type` field (with extends [`Cell`](/docs/3.1/7-api/0-interfaces/4-cell/) interface).
...
| -----------       | -------                                                           | -----------   |
| [`key: string`]   | [`CellTemplate`](/docs/3.1/7-api/0-interfaces/5-cell-template/)   | Type of a cell template and its implementation | 
